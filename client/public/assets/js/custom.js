...
$(document).ready(function($) {
  ...
  navigationLi.hover(function() {
    if ($("body").hasClass("navigation-fixed-bottom")) {
      if ($(window).width() > 768) {
        var spaceUnderNavigation =
          $(window).height() - ($(this).offset().top - $(window).scrollTop());
        if (
          spaceUnderNavigation <
          $(this)
  ...
  $(window).scroll(function() {
    ...
    if ($("body").hasClass("navigation-fixed-bottom")) {
      if (
        $(window).scrollTop() >
        $(window).height() - $(".navigation").height()
      ) {
  ...
  $('.navigation .nav a[href^="#"], a[href^="#"].roll').on("click", function(
    e
  ) {
    e.preventDefault();
